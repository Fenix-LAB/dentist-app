...
"}")
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("../Modulo_CD/icons/Health-PNG-HD-Quality.png"))
...
"")
        ...
        self.btn_boca_cerrada = QtWidgets.QPushButton(self.frame_2)
        ...
        self.btn_45_grd = QtWidgets.QPushButton(self.frame_2)
        ...
        self.btn_55_grd = QtWidgets.QPushButton(self.frame_2)
        ...
        self.frame_7.setMinimumSize(QtCore.QSize(350, 350))
...
"")
        ...
        self.graph_apertura = QtWidgets.QVBoxLayout()
        self.graph_apertura.setObjectName("graph_apertura")
        self.horizontalLayout_16.addLayout(self.graph_apertura)
        ...
        self.pre = QtWidgets.QLabel(self.frame_3)
        ...
        self.pre_sensor_1 = QtWidgets.QLabel(self.frame_3)
        ...
        self.pre_sensor_2 = QtWidgets.QLabel(self.frame_3)
        ...
        self.pre_sensor_3 = QtWidgets.QLabel(self.frame_3)
        ...
        self.pre_2 = QtWidgets.QLabel(self.frame_6)
        ...
        self.mo_sensor_1 = QtWidgets.QLabel(self.frame_6)
        ...
        self.mo_sensor_2 = QtWidgets.QLabel(self.frame_6)
        ...
        self.mo_sensor_3 = QtWidgets.QLabel(self.frame_6)
...
"")
        ...
        self.line_nombre = QtWidgets.QLineEdit(self.frame_8)
        self.line_nombre.setMinimumSize(QtCore.QSize(250, 30))
        ...
        self.btn_save_nombre = QtWidgets.QPushButton(self.frame_8)
        self.btn_save_nombre.setMinimumSize(QtCore.QSize(40, 40))
        self.btn_save_nombre.setMaximumSize(QtCore.QSize(40, 16777215))
        self.btn_save_nombre.setStyleSheet("border-radius:18px;")
        self.btn_save_nombre.setText("")
        self.btn_save_nombre.setIcon(icon6)
        self.btn_save_nombre.setIconSize(QtCore.QSize(25, 25))
        self.btn_save_nombre.setObjectName("btn_save_nombre")
        self.horizontalLayout_21.addWidget(self.btn_save_nombre)
        ...
        self.line_matricula = QtWidgets.QLineEdit(self.frame_8)
        self.line_matricula.setMinimumSize(QtCore.QSize(250, 30))
        ...
        self.btn_save_matricula = QtWidgets.QPushButton(self.frame_8)
        self.btn_save_matricula.setMinimumSize(QtCore.QSize(40, 40))
        self.btn_save_matricula.setMaximumSize(QtCore.QSize(40, 16777215))
        self.btn_save_matricula.setStyleSheet("border-radius:18px;")
        self.btn_save_matricula.setText("")
        self.btn_save_matricula.setIcon(icon6)
        self.btn_save_matricula.setIconSize(QtCore.QSize(25, 25))
        self.btn_save_matricula.setObjectName("btn_save_matricula")
        self.horizontalLayout_22.addWidget(self.btn_save_matricula)
        ...
        self.table_datos = QtWidgets.QTableWidget(self.frame_8)
        ...
        self.table_datos.setColumnCount(4)
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "Sensor 45°"))
        item = self.table_datos.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "Sensor 55°"))
